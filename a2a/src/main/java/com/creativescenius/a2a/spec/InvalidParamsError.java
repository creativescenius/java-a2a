...
public class InvalidParamsError {
    ...
    public InvalidParamsError withCode(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public InvalidParamsError withMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public InvalidParamsError withData(Object data) {
        this.data = data;
        return this;
    }
    ...
    public InvalidParamsError withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
